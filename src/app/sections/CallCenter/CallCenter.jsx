...
const CallCenter = () => {
  ...
  const startProgram = async () => {
    ...
    setAttendantStats(stats);
    setClient(remainingClients2 > 0 ? remainingClients2 : 0);
  };
            ...
            <table className="col-span-3 card_1">
              <thead>
                <tr>
                  ...
                  <th>
                    <p className="text-center">Atendentes</p>
                  </th>
                  <th>
                    <p className="text-center">tempo (minutos)</p>
                  </th>
                </tr>
              </thead>
              <tbody>
                {day.map((result, index) => (
                  ...
                  >
                    ...
                    <td>
                      <p className="text-center">{result.attendants}</p>
                    </td>
                    <td>
                      <p className="text-center">
                        {result.time / result.clients / 1000}
                      </p>
                    </td>
                  </tr>
                ))}
