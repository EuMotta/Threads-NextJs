...
import HeroCallCenter from '../../../../../images/Process/ProcessUse/Hero.svg';
      ...
      >
        <div className="mx-5">
          ...
          <div className="text-3xl font-bold mb-2 leading-tight">
            <h3>Confira abaixo exemplos de renderização 3D</h3>
            <div className="text-blue-600 text-3xl">
              <Typewriter
                options={{
                  strings: ['Rosto realista', 'Carteira de identificação'],
                  autoStart: true,
                  loop: true,
                }}
              />
          ...
          <div className="font-mono text-xl mt-5">
            <h4>Acompanhe o uso do processador pelo Gerênciador de tarefas</h4>
          </div>
        </div>
      </motion.div>
      <motion.div
